        ...
        <div className="bio-section">
          ...
          <div className="bio-content">
            ...
            <p className="bio-description">
              ...
              experience developing academic and personal projects using modern
              web technologies especially using Laravel, PHP(MVC Structure), Vue.js, Node.js, React.js, JavaScript and MySQL, MongoDB. I am eager to apply my technical skills, learn
              from industry professionals, and contribute to creating
              high-quality web applications that deliver great user experiences.
            </p>
        ...
        <div className="philosophy-section">
          ...
          <div className="philosophy-cards">
            ...
            <div className="philosophy-card">
              ...
              <p>
                Speed and efficiency are at the heart of every project I create.
              </p>
            </div>
            <div className="philosophy-card">
              <div className="card-icon">👥</div>
              <h3>User Focused</h3>
              <p>
                The end user's experience is always my primary consideration.
              </p>
            </div>
            <div className="philosophy-card">
              <div className="card-icon">📚</div>
              ...
              <p>
                Technology evolves, and so do I. Always learning and improving.
              </p>
            </div>
          </div>
        </div>
